    ...
    <div className='bg-zinc-900 px-12 h-screen py-8'>
          ...
          {Cart.map((item, i) => (
            <div
              ...
              <div className="flex mt-4 w-full md:w-auto items-center justify-between">
                ...
                <button className='bg-red-100 text-red-700 border-red-700 rounded p-2 ms-12' onClick={() => deleteItem(item._id)}>
                  <AiFillDelete />
                </button>
              </div>
            </div>
      ...
      {Cart && Cart.length > 0 && (
        <div className="mt-4 w-full flex items-center justify-between">
          <div className="p-4 bg-zinc-800 rounded w-[65%]">
          ...
          <button
            className="bg-red-500 text-white rounded px-6 py-3 font-semibold h-fit"
            onClick={clearCart}
          >
            Clear Cart
          </button>
